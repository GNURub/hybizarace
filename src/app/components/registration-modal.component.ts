  ...
  template: `
    @if (isOpen()) {
      ...
      >
        ...
        >
          <!-- Modal Header -->
          <div class="sticky top-0 bg-slate-900 border-b border-yellow-400/30 p-6 rounded-t-3xl">
          ...
          <div class="p-6">
            <!-- Warning Banner -->
            <div class="bg-yellow-400/10 border border-yellow-400/30 rounded-xl p-4 mb-6">
              <div class="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p class="text-gray-300 text-sm">
                    Selecciona tu categoría y modalidad antes de proceder al pago.
                    Esta información será necesaria para completar tu inscripción.
                  </p>
                </div>
              </div>
            </div>
            ...
            <!-- Category Selector -->
            <div class="bg-slate-800/50 backdrop-blur-sm border border-yellow-400/20 rounded-2xl p-6 mb-6">
              <app-category-selector />
            </div>

            <!-- Pricing Info -->
            <div class="bg-gradient-to-r from-yellow-400/10 to-orange-500/10 border border-yellow-400/30 rounded-xl p-6 mb-6">
          ...
          <!-- Modal Footer -->
          <div class="sticky bottom-0 bg-slate-900 border-t border-yellow-400/30 p-6 rounded-b-3xl">

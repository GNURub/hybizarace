              ...
              >
                <div class="flex items-start gap-3">
                  ...
                  <div>
                    <h4 class="text-yellow-400 font-bold mb-1">Importante</h4>
                    <p class="text-gray-300 text-sm">
                      Sólo puedes registrarte en la modalidad élite vía
                      formulario de aceptación.
                      <a
                        href="https://forms.office.com/pages/responsepage.aspx?id=DQSIkWdsW0yxEjajBLZtrQAAAAAAAAAAAAZ__poBFb9URE1EVzlBM1JJUkU4NU9KSVNSNFhTVEE0Sy4u&origin=lprLink&route=shorturl"
                        class="text-yellow-400 underline"
                        target="_blank"
                        rel="noopener noreferrer"
                        >Haz clic aquí para acceder al formulario.</a
                      >
                    </p>
                  </div>
                </div>

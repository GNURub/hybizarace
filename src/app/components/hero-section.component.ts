...
@Component({
  ...
  template: `
    <section
      class="min-h-screen flex items-center justify-center bg-slate-950 relative overflow-hidden"
    >
      <!-- Background Effects -->
      <div
      ...
      ></div>
      <div
        class="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(254,206,0,0.1),transparent_70%)]"
      ></div>
      ...
      <div class="container mx-auto px-4 text-center relative z-10">
        ...
        <div class="max-w-4xl mx-auto">
          ...
          <p class="text-xl md:text-2xl text-gray-300 mb-8 max-w-2xl mx-auto">
            El desafío fitness más épico de Ibiza. 9 estaciones de poder que
            pondrán a prueba tu resistencia.
          </p>
          ...
          <!-- Event Info -->
          <div
            class="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-2xl mx-auto"
          >
